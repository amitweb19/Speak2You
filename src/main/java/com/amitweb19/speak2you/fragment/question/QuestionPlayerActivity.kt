...
import kotlinx.android.synthetic.main.activity_question_player.*
import java.text.DecimalFormat
import java.text.NumberFormat

class QuestionPlayerActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_question_player)
